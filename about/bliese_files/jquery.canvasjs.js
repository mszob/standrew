...
(function () {
    ...
    var defaultOptions = {
        ...
        Title: {
            ...
            fontFamily: "PopuLato, 'Helvetica Neue', Helvetica, Arial, sans-serif",
        ...
        Axis: {
            ...
            titleFontSize: 20,
            titleFontFamily: "PopuLato, 'Helvetica Neue', Helvetica, Arial, sans-serif",
            titleFontWeight: "normal",
            titleFontStyle: "normal",

            labelAngle: 0,
            labelFontFamily: "PopuLato, 'Helvetica Neue', Helvetica, Arial, sans-serif",
            ...
            labelFormatter: null, //KEEP added label formatter for custom label formatting
        ...
        DataSeries: {
            ...
            indexLabelFontFamily: "PopuLato, 'Helvetica Neue', Helvetica, Arial, sans-serif",
    ...
    Axis.prototype.createLabels = function () {
        ...
        if (this.type === "axisX" && this.chart.plotInfo.axisXValueType === "dateTime") {
            ...
            for (i = this.intervalstartTimePercent; i <= endPoint; i = parseFloat((i + this.interval).toFixed(14))) {
                ...
                //KEEP added label formatter for custom label formatting
                if (this.labelFormatter && typeof this.labelFormatter == 'function'){
                    var text = this.labelFormatter(i);
                }
                else {
    ...
    ToolTip.prototype._initialize = function () {
        ...
        if (this.enabled) {
            ...
            toolTipHtml += "font-family: PopuLato, 'Helvetica Neue', Helvetica, sans-serif;";
    ...
    EventManager.prototype.fireEvent = function (eventObjectMap, eventType, ev) {
        ...
        if (userContext && eventContext && userContext[eventContext[eventType]]){
            //KEEP Joel added 3/25/2015 so we can use a string name in the json array for custom events
            if (typeof userContext[eventContext[eventType]] == 'string' && typeof window[userContext[eventContext[eventType]]] == 'function'){
                window[userContext[eventContext[eventType]]].call(userContext, eventParameter);
            }
            else {
